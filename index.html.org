...
<head>
  ...
  <meta name="description" content="Pass a warm note. '#kindness'">
  ...
  <!-- (optioneel) themekleur voor mobiele UI chrome -->
  ...
  <header class="topbar" data-topbar>
    ...
    <nav class="actions" aria-label="Acties">
      <button id="btn-new" class="btn btn-ico" type="button" aria-label="Nieuwe boodschap">
        <span class="btn-label">Kies bericht</span>
      </button>
        <!-- =================== AI Message =================== 
...
<div id="lang-dd" class="lang-dd">
  ...
  <!-- Mobile boot intro (mobile-only via CSS) -->
<div id="intro-boot" class="intro-boot" aria-live="polite" aria-label="App wordt geladen" role="status">
  <div class="intro-boot__center">
	<div class="intro-boot__logo" aria-hidden="true">
  		<img src="/assets/icons/logo_transparent_64px.png" srcset="/assets/icons/logo_transparent_64px.png 1x, /assets/icons/logo_transparent_128px.png 2x" alt="" class="intro-logo-img" decoding="async" fetchpriority="high"/>
	</div>
  ...
  <main class="page" role="main">
    ...
    <div id="coach-tip" class="coach" role="status" aria-live="polite">
      <span class="coach-text">Welkom</span>
    </div>
  </main>
  ...
  <div id="about-backdrop" class="sheet-backdrop hidden" aria-hidden="true">
    <section class="sheet sheet--about" role="dialog" aria-modal="true" aria-labelledby="about-title">
      ...
      <div class="sheet-body">
		...
		<div class="intro-boot__logo" aria-hidden="true">
  			<img src="/assets/icons/logo_transparent_64px.png" srcset="/assets/icons/logo_transparent_64px.png 1x, /assets/icons/logo_transparent_128px.png 2x" width="64" height="64" alt="">
		</div>
